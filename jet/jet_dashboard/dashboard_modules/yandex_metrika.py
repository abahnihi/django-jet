...
class YandexMetrikaVisitorsTotals(YandexMetrikaBase):
    ...
    template = 'jet.jet_dashboard/modules/yandex_metrika_visitors_totals.html'
...
class YandexMetrikaVisitorsChart(YandexMetrikaBase):
    ...
    template = 'jet.jet_dashboard/modules/yandex_metrika_visitors_chart.html'
    ...
    class Media:
        js = ('jet.jet_dashboard/vendor/chart.js/Chart.min.js', 'jet.jet_dashboard/dashboard_modules/yandex_metrika.js')
...
class YandexMetrikaPeriodVisitors(YandexMetrikaBase):
    ...
    template = 'jet.jet_dashboard/modules/yandex_metrika_period_visitors.html'
