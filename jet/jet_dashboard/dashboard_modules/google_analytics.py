...
class GoogleAnalyticsVisitorsTotals(GoogleAnalyticsBase):
    ...
    template = 'jet.jet_dashboard/modules/google_analytics_visitors_totals.html'
...
class GoogleAnalyticsVisitorsChart(GoogleAnalyticsBase):
    ...
    template = 'jet.jet_dashboard/modules/google_analytics_visitors_chart.html'
    ...
    class Media:
        js = ('jet.jet_dashboard/vendor/chart.js/Chart.min.js', 'jet.jet_dashboard/dashboard_modules/google_analytics.js')
...
class GoogleAnalyticsPeriodVisitors(GoogleAnalyticsBase):
    ...
    template = 'jet.jet_dashboard/modules/google_analytics_period_visitors.html'
