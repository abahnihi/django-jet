...
class DashboardModule(object):
    ...
    template = 'jet.jet_dashboard/module.html'
    enabled = True
...
class AppList(DashboardModule):
    ...
    template = 'jet.jet_dashboard/modules/app_list.html'
...
class ModelList(DashboardModule):
    ...
    title = _('Models')
    template = 'jet.jet_dashboard/modules/model_list.html'
...
class RecentActions(DashboardModule):
    ...
    template = 'jet.jet_dashboard/modules/recent_actions.html'
...
class Feed(DashboardModule):
    ...
    title = _('RSS Feed')
    template = 'jet.jet_dashboard/modules/feed.html'
